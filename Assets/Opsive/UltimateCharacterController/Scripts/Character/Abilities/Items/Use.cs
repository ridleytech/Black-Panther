...
namespace Opsive.UltimateCharacterController.Character.Abilities.Items
{
    ...
    public class Use : ItemAbility
    {
        ...
        private void UseItem(int slotID)
        {
            ...
            //this.m_GameObject.transform.LookAt(g.transform);
        ...
        public override void LateUpdate()
        {
            ...
            //m_CharacterLocomotion.EnableColliderCollisionLayer(true); //randall
            ...
            //m_CharacterLocomotion.EnableColliderCollisionLayer(false); //randall
        }
