...
public class EmeraldHealthBar : MonoBehaviour {
	...
	void UpdateUI (){
		if (HealthBar != null 
			|| HealthBar != null && EmeraldComponent.BehaviorRef == Emerald_AI.CurrentBehavior.Companion 
			|| HealthBar != null && EmeraldComponent.BehaviorRef == Emerald_AI.CurrentBehavior.Pet){
	...
	void Update (){
		...
		if (HealthBar != null 
			|| HealthBar != null && EmeraldComponent.BehaviorRef == Emerald_AI.CurrentBehavior.Companion
			|| HealthBar != null && EmeraldComponent.BehaviorRef == Emerald_AI.CurrentBehavior.Pet
			|| HealthBar != null && EmeraldComponent.BehaviorRef == Emerald_AI.CurrentBehavior.Passive && EmeraldComponent.PassiveTargetRef != null){
